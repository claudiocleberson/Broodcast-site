                         ...
                         <div class="main_home">
                             <div class="col-md-6">
                                 ...
                                 <div class="home_btns m-top-40 m-bottom-20 text-center">
                                     <a href="https://itunes.apple.com/us/app/broodcast/id1373347688?ls=1&mt=8" target="_blank" style="background-color: #fc6a42 " class=" btn btn-danger m-top-20"><i class="p-r-15 fa fa-apple"></i>{{$t('messages.download')}}</a>
                         ...
                         <div class="main_features p-top-100">
                             <div class="col-md-8 col-md-offset-2 col-sm-12 col-xs-12">
                                 <div class="head_title text-center">
                                     ...
                                     <p>{{$t('messages.whyBroodcastMsg')}}</p>
                                 </div>
                             </div>
